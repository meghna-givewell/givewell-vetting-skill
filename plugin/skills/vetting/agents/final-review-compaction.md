...
Count all rows with ✓ in column I. If the ✓ count is **strictly greater than 20%** of all findings rows (✓ count / total findings > 0.20; at exactly 20%, skip this step), apply the following triage pass before proceeding to Step 4.
