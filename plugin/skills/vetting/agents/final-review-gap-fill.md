...
| Grant amount consistency | `stg-params-A` and `stg-params-B` | Low/Assumption: "No finding or clean declaration for grant amount consistency. Confirm formula-check-parameters ran and completed Check 5." |
...
Coverage declaration: "Category coverage check complete. Categories confirmed covered: [N/14]. Gaps filed: [list of categories or 'none']. key-params-check coverage log: [N of M — complete / incomplete / staging tab not found]."
