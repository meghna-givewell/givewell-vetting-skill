...
- Column F: `COVERAGE_ROWS: full chain trace (not row-sequential) | Staging sheet: [name from session context]. Traced CE chain: [N] cells across [sheet name(s)]. Filed [K] findings in rows 2–[K+1]. Grant-doc comparison: [performed — doc ID: [ID] | skipped — no grant doc in session context; compared against Step 0.5 program context instead]. Funging/leverage formula error deferral: [list any deferred funging/leverage formula observations with cell refs, or 'none'].`
