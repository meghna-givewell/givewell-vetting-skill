...
Column reference: **A** Finding # (leave blank) | **B** Sheet | **C** Cell/Row | **D** Severity | **E** Error Type/Issue | **F** Current Formula/Value | **G** Recommended Fix | **H** Explanation | **I** Changes CE? (mark ✓ — chain errors almost always change CE directly) | **J** Estimated CE Impact | **K** Needs input? | **L** Status (leave blank)
