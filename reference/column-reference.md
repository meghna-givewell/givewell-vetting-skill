...
- **Missing Source always goes to Publication Readiness** unless the value itself is suspect (labeled "guess," outside plausible range, or inconsistent with other sources) — in that case, use Findings.
